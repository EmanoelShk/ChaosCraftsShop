using ChaosCraftsShop.TagHelpers;
...
namespace ChaosCraftsShopTests.TagHelpers
{
    public class EmailTagHelperTests
    {
        ...
        {
            EmailTagHelper emailTagHelper = new EmailTagHelper() { Address = "test@chaoscraftsshop.com", Content = "Email" }; ;
            ...
            Assert.Equal("mailto:test@chaoscraftsshop.com", tagHelperOutput.Attributes[0].Value);
        }
    }
}
